...
export default function CameraScreen() {
  ...
  const addWatermark = async (uri: string): Promise<string> => {
    try {
      ...
      // For a production app, you would use expo-image-manipulator with SVG overlay
      // or a library like react-native-image-marker to burn text into the image
      
      // For now, we'll return the original URI and display metadata in the UI
      // The metadata will be: timestamp, officer name, and location
